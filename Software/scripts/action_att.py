...
from scripts import Action_input

from scripts.PreProcesses import body_rotation_cos, body_rotation, feature_only_diff, one_hot_labeling
...
def play_action(DATA_PATH1, DATA_PATH2, DATA_PATH3):
    ...
    with tf.Graph().as_default(), tf.Session(config=sessConfig) as session:
        with tf.device('/cpu:0'):
            ...
            saver.restore(session, "./scripts/TrialSaver/Bi Long-Short Term Att/TJ_Bi Long-Short Term Att.ckpt-400")    
